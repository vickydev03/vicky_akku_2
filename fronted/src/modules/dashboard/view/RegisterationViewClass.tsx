...
export default function CreateClassView() {
  ...
  const mutate = useMutation(trpc.regularClasses.createregularClasses.mutationOptions({
    onSuccess: () => toast.success("Regular Class Created"),
    onError: () => toast.error("Something went wrong"),
  }));

  const onSubmit = async (v: FormValues) => mutate.mutateAsync(v)
