  ...
  const editor = useEditor({
    ...
    extensions: [
      ...
      Placeholder.configure({
        placeholder:
          "Describe what attendees will learn, who it's for, and what to expect…",
      }),
      Link.configure({
        openOnClick: false,
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-neutral prose-sm max-w-none min-h-[160px] px-4 py-3 focus:outline-none",
      },
    },
  });
...
export function ThumbnailUploader({
  ...
  const upload = useCallback(
    async (file: File) => {
      if (!file.type.startsWith("image/")) {
        setState({ s: "error", msg: "Images only (JPG, PNG, WEBP)" });
        return;
      }
      if (file.size > 10 * 1024 * 1024) {
        setState({ s: "error", msg: "Max file size is 10 MB" });
        return;
      }
      ...
      xhr.upload.onprogress = (e) => {
        if (e.lengthComputable)
          setState({ s: "uploading", pct: (e.loaded / e.total) * 100 });
      };
      xhr.onload = () => {
  ...
  return (
    <div
      ...
      className={cn(
        "relative rounded-xl overflow-hidden border-2 border-dashed transition-all",
        drag
      ...
      {state.s === "idle" && (
        ...
        >
          ...
          <p className="text-sm text-neutral-500">
            Drop image or{" "}
            <span className="text-neutral-900 font-semibold underline underline-offset-2">
              choose file
            </span>
          </p>
        ...
        <div className="group relative">
          ...
          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
            <button
              type="button"
              onClick={() => inputRef.current?.click()}
              className="px-3 py-1.5 bg-white/90 hover:bg-white rounded-lg text-xs font-semibold text-neutral-800 transition-colors flex items-center gap-1.5"
            >
            ...
            <button
              ...
              className="px-3 py-1.5 bg-black/50 hover:bg-black/70 rounded-lg text-xs font-semibold text-white transition-colors flex items-center gap-1.5"
            >
      ...
      {state.s === "error" && (
        <div className="h-40 flex flex-col items-center justify-center gap-2">
          ...
          <button
            ...
            className="text-xs text-neutral-500 underline underline-offset-2 mt-1"
          >
            Try again
          </button>
        </div>
...
//   console.log(workshop, "check");
  ...
  const onSubmit = async (v: FormValues) => await mutate.mutateAsync({...v,id});
                ...
                <div className="p-8">
                  ...
                  {step === 0 && (
                    <div className="space-y-6">
                      <SectionTitle
                        ...
                        subtitle="Give your workshop a compelling title and detailed description."
                      />
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <div className="relative flex items-center">
                                <span className="absolute left-3 text-xs text-neutral-400 font-mono select-none pointer-events-none">
                                  /workshop/
                                </span>
                                <Input
                  ...
                  {step === 1 && (
                    <div className="space-y-6">
                      <SectionTitle
                        step={2}
                        label="Media & Pricing"
                        subtitle="Upload a cover thumbnail and set your ticket price."
                      />
                  ...
                  {step === 2 && (
                    <div className="space-y-6">
                      <SectionTitle
                        step={3}
                        label="Scheduling & Venue"
                        subtitle="Set the event date and pick a physical location."
                      />
                        ...
                        <div className="flex gap-4 p-4 rounded-xl bg-neutral-50 border border-neutral-200">
                          ...
                          <div className="min-w-0">
                            ...
                            {selectedLocation.place && (
                              <p className="text-xs font-medium text-neutral-600 mb-0.5">
                                {selectedLocation.place}
                              </p>
                            )}
                  ...
                  {step < 2 ? (
                    ...
                    >
                      {form.formState.isSubmitting ? (
                        ...
                        <>
                          <SendHorizontalIcon className="w-4 h-4" /> Publish
                          Workshop
                        </>
                      )}
                    </button>
